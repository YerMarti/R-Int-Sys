...
solve.problem <- function() {
  ...
  dls_ts <- depth.limited.search(problem, max_iterations = 100, count_print = 50, depth_limit = 10)
  dls_gs <- depth.limited.search(problem, max_iterations = 100, count_print = 50, depth_limit = 10, graph_search = TRUE)
